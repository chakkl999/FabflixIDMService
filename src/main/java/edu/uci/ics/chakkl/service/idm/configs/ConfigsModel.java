...
public class ConfigsModel {
    ...
    public Map<String, String> getbotcatcherConfig() { return botcatcherConfig;}

    public void setbotcatcherConfig(Map<String, String> botConfig) {this.botcatcherConfig = botConfig;}
}